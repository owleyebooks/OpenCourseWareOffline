...
{
    [Theory]
    [InlineData(ArtifactFileType.Pdf)]
    [InlineData(ArtifactFileType.Html)]
    public void IsViewable_TrueWhenViewableTypeAndFileDownloaded(ArtifactFileType fileType)
    {
    ...
    [Theory]
    [InlineData(ArtifactFileType.Zip)]
    [InlineData(ArtifactFileType.Other)]
    public void IsViewable_FalseForNonViewableTypesEvenWhenDownloaded(ArtifactFileType fileType)
    {
