...
public class ArtifactViewingLogicTests
{
    ...
    [Theory]
    [InlineData(ArtifactFileType.Html, true)]
    [InlineData(ArtifactFileType.Html, false)]
    public void CanEmbed_Html_TrueOnEveryPlatform(ArtifactFileType fileType, bool isIOS)
    {
    ...
    public void CanEmbed_NonViewableTypes_AlwaysFalse(ArtifactFileType fileType)
    {
