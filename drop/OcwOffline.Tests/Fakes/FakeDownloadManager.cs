...
/// Members beyond IDownloadManager are for test setup/assertions. See AUDIT_TRAIL v34.
/// </summary>
public class FakeDownloadManager : IDownloadManager
{
    ...
    // signature has no progress key. Consumed on use, see AUDIT_TRAIL v35.
        ...
        CancellationToken externalToken = default)
    {
        ...
        // WasPaused() stays true regardless — see AUDIT_TRAIL, this round.
