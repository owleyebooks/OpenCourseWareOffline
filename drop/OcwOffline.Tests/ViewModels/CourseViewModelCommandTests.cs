...
public class CourseViewModelCommandTests
{
    ...
    // internal, never called unless ScrapeDownloadPageAsync itself runs) —
    // same reasoning already used for OcwCatalogService at v32.
    private static CourseViewModel CreateViewModel(out FakeCourseDatabase db, out FakeDownloadManager downloads)
    {
        ...
        return new CourseViewModel(new OcwScraperService(), db, downloads);
    }
