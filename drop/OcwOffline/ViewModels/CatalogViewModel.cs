...
public partial class CatalogViewModel : ObservableObject
{
    ...
    // Extracted from ApplyFilter, behavior unchanged — pure filtering logic,
    // no ObservableCollection/instance state, so it's directly testable
    // without constructing a live OcwCatalogService call chain. Refactor,
    // not just an accessibility bump. See AUDIT_TRAIL v32.
