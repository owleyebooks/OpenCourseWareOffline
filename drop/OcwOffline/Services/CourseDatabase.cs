...
public class CourseDatabase : ICourseDatabase
{
    ...
    private async Task<SQLiteAsyncConnection> GetConnectionAsync()
    {
        ...
        try
        {
            ...
            var dbPath = Path.Combine(AppPaths.Root, "ocw_offline.db3");
    ...
    /// <summary>
    /// Same idea for Lectures, keyed on VideoUrl — falls back to Title
    ...
    /// wrongly reconcile as already-downloaded on a later re-fetch. See AUDIT_TRAIL v12.
    /// </summary>
