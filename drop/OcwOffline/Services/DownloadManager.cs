...
/// <summary>
/// Watchdog cancellation, not Pause() — same exception type would
/// otherwise conflate the two. See AUDIT_TRAIL v19.
/// </summary>
...
public class DownloadManager : IDownloadManager
{
        ...
        CancellationToken externalToken = default)
    {
        ...
        try
        {
            ...
            // Failed. Full reasoning: AUDIT_TRAIL v8.
        ...
        catch (OperationCanceledException) when (stalled)
        {
            ...
            // (AUDIT_TRAIL v8) picks this back up on retry like any other
    ...
    // Extracted from DownloadAsync's inline logic, same v31 round as the
    // DownloadProgress slice — a real refactor, not an accessibility bump
    // (didn't exist before). Behavior unchanged; see SCRATCHPAD_seam_design.md
    // and AUDIT_TRAIL v31 for why this pair was pulled out this way.
    ...
    private static void ApplyBackupExclusion(string filePath)
    {
        ...
        // call like iOS. See AUDIT_TRAIL v9.
    }
