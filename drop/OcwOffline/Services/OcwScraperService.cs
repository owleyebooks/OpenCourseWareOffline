...
public class OcwScraperService : IOcwScraperService
{
    ...
    // yet) — flags instead of silently dropping. See AUDIT_TRAIL v16.
    ...
    // internal, not private, since v31 — both take an HtmlDocument built
    // from a literal string (HtmlDocument.LoadHtml is itself I/O-free), no
    // mock needed. Same slice-off pattern as MakeAbsolute/ParseSize/
    // ClassifyArtifact. See AUDIT_TRAIL v31 and SCRATCHPAD_seam_design.md.
    ...
    // internal, not private, since v30 — pure BCL, no I/O, same slice-off
    // pattern as OcwCatalogService's SlugFromUrl/ToCatalogEntry. See AUDIT_TRAIL v30.
