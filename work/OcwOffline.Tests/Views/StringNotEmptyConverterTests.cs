...
public class StringNotEmptyConverterTests
{
    ...
    [Theory]
    [InlineData("null counts as empty", null)]
    [InlineData("empty string counts as empty", "")]
    public void Convert_NullOrEmptyString_ReturnsFalse(string description, string? value)
    {
