...
public class InvertedBoolConverterTests
{
    ...
    [Theory]
    [InlineData("true inverts to false", true, false)]
    [InlineData("false inverts to true", false, true)]
    public void Convert_BoolValue_ReturnsInverse(string description, bool input, bool expected)
    {
    ...
    [InlineData("true inverts to false", true, false)]
    [InlineData("false inverts to true", false, true)]
    public void ConvertBack_BoolValue_ReturnsInverse(string description, bool input, bool expected)
    {
