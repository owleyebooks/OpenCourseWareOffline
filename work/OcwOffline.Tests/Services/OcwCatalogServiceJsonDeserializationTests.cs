...
/// hand-builds the DTOs in C#, bypassing JsonSerializer entirely. The sample
/// captures the live API shape.
/// </summary>
public class OcwCatalogServiceJsonDeserializationTests
{
    ...
    // literal: csharp_lint.py's brace-stripper can't parse raw strings.
