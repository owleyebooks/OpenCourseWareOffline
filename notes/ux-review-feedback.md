...
- One reviewer also notes the copy hides that a bare course identifier works: the placeholder could mention typing the course's page name as an alternative.
